...
export const EducationCertifications: React.FC = () => {
  return (
    <section id="education" className="py-24 border-b border-black/10 dark:border-white/10">
            ...
            <div className="space-y-6">
              {EDUCATION.map((edu, idx) => (
                <motion.div
                  ...
                  className="bg-black/[0.02] dark:bg-white/[0.02] rounded-xs p-6 sm:p-7 border border-black/15 dark:border-white/15"
                >
