...
export const Experience: React.FC = () => {
  return (
    <section id="experience" className="py-24 border-b border-black/10 dark:border-white/10">
        ...
        <div className="space-y-10 relative before:absolute before:inset-0 before:left-4 sm:before:left-6 md:before:left-8 before:w-px before:bg-black/15 dark:before:bg-white/15 before:content-['']">
          {EXPERIENCES.map((exp, index) => (
            ...
            >
              ...
              {/* Experience Card */}
              <div className="bg-black/[0.02] dark:bg-white/[0.02] rounded-xs p-6 sm:p-8 border border-black/15 dark:border-white/15 transition-all">
                {/* Header info */}
