...
export const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-24 border-b border-black/10 dark:border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {SKILL_CATEGORIES.map((cat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-black/[0.02] dark:bg-white/[0.02] rounded-xs p-6 sm:p-8 border border-black/15 dark:border-white/15"
              >
                {/* Category Header */}
        ...
        <div className="mt-12 p-6 rounded-xs bg-black/[0.02] dark:bg-white/[0.02] border border-black/15 dark:border-white/15 flex flex-col md:flex-row items-center justify-between gap-4">
